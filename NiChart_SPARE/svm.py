...
# def correct_linearsvr_bias(svr_model, X_train, y_train):
    ...
    # print('Original Intercept:',svr_model.intercept_, "Original coef:", svr_model.coef_)
    # # Correct the intercept of the new model by adding the bias
    # corrected_model.intercept_ += bias
    # print('Adjusted Intercept:',corrected_model.intercept_,  "Adjusted coef:", svr_model.coef_)

    # return corrected_model


# def get_linearsvr_bias(X_train, y_train):

#     """
#     Correction based on target residuals
...
#     y_pred_linear = corrector.predict(X_train)
#     print('meanage:',np.mean(y_pred_linear))
#     # # inverse scale the predicted value
#     # y_pred_linear = feature_scaler.inverse_transform(y_pred_linear)
#     bias = np.mean(y_train - y_pred_linear)
#     # corrected_prediction = svr_prediction - bias
#     print("Bias:", bias)
